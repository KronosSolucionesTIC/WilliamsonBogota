...
if($eliminacion==1) {//confirmacion de eliminacio 
	$error=eliminar("empresa",$eli_codigo,"cod_jmc");
	if ($error >=1)
...
<tr>
<td valign="top" >
<form id="forma_total" name="forma_total" method="post" action="man_empresa.php">
                      ...
                      <td bgcolor="#E9E9E9"><table width="624" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="160" class="ctablaform"><select name="campos" class="textfieldlista" id="campos" >
                            ...
                            <option value="nom_jmc">Nombre</option>
                            <option value="nit_jmc">Nit</option>
							<option value="nit_jmc">Direccion</option>
							<option value="nit_jmc">Telefono</option>
							<option value="nit_jmc">Fax</option>
							<option value="nit_jmc">Sitio Web</option>
							<option value="nit_jmc">Lugar</option>
                    ...
                    <tr>
                      <td><table width="624" border="0"  cellpadding="0">
                        <tr>
						  ...
						  <td  class="ctablasup">SITIO WEB</td>
						  <td  class="ctablasup">LUGAR</td>
                          <td  class="ctablasup"  width="112">OPCIONES</td>
                        </tr>
						<? 
						
						echo "<tr style='display:none'><td ><form name='forma_0' action='man_empresa.php'>";
						echo "  </form> </td></tr>  ";						  
						$estilo="ctablablanc";
						$estilo="ctablagris";
						...
						while($db->next_row()) {
							...
							echo "<tr class='$estilo' $cambio_celda> <form name='forma_$db->cod_jmc' action='man_empresa.php'>  ";
							$nombre_emp =letra_capital($db->nom_jmc);
							$nit=convertir_nit($db->nit_jmc);  
							$direccion = letra_capital($db->dir_jmc);
							$lugar = letra_capital($db->lugar_jmc);
							echo "<td >$nombre_emp </td>";
							echo "<td >$nit</td>";
							echo "<td >$direccion</td>";
							echo "<td >$db->tel_jmc</td>";
							echo "<td >$db->fax_jmc</td>";
							echo "<td >$db->pag_jmc</td>";
							echo "<td >$lugar</td>";
                            echo "<td aling='center' >"; 
							
							echo 	"<table width='100%' border='0' cellspacing='0' cellpadding='0'>";
                            echo 	" <tr>  <td align='center'> <input type='hidden' name='codigo' value='$db->cod_jmc'>";
							if ($editar==1)
							 	echo "<img src='imagenes/icoeditar.gif' alt='Editar Registro' width='16' height='16' style='cursor:pointer'  onclick='document.forma_$db->cod_jmc.submit()'/></td>";
							else 
								echo "<img src='imagenes/e_icoeditar.gif' width='16' height='16'  /></td>";
                            echo 	"<td align='center'>";
							/*if ($eliminar==1)
								echo"<img src='imagenes/icoeliminar.gif' width='16' alt='Eliminar Registro' height='16' style='cursor:pointer' onclick=confirmar($db->cod_jmc) /></td> ";
							else
...
<form name="forma" method="post" action="con_empresa.php">
