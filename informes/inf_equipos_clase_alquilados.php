			  ...
			  <TD align="center"><table width="82%" border="1" cellpadding="1" cellspacing="1" bordercolor="#333333" id="select_tablas" >
				...
				$db->query($sql);
					...
					while($db->next_row()){ 	
						...
						$sqlcon = "SELECT cod_cliente,consecutivo,fecha_ini_contrato,fecha_fin_contrato FROM listado_equipos 
						...
						$sqlcl = "SELECT * FROM cliente WHERE cod_cli = $cod_cliente";
						$dbcl = new Database();
						$dbcl->query($sqlcl);					
						$dbcl->next_row();
