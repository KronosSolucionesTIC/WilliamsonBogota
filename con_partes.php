...
if($eliminacion==1) {//confirmacion de eliminacion 
	$error=eliminar("partes",$eli_codigo,"cod_partes");
	if ($error >=1)
...
<tr>
<td valign="top" >
<form id="forma_total" name="forma_total" method="post" action="man_partes.php">
                  <table width="624" border="0" cellspacing="0" cellpadding="0" align="center" >
                    <tr>
                      <td bgcolor="#E9E9E9"><table width="624" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="17"> 
						  <? if ($insertar==1) {?>
					  	  <img src="imagenes/page.png" width="16" height="16"  alt="Nuevo Registro" style="cursor:pointer" onClick="location.href='man_partes.php?codigo=0&editar=<?=$editar?>&insertar=<?=$insertar?>&eliminar=<?=$eliminar?>'"/>
					  	  <? } ?></td>
                          ...
                          <td width="160" class="ctablaform"><select name="campos" class="textfieldlista" id="campos" >
                           <option value="0">Seleccion</option>
                            <option value="cod_partes">Codigo</option>
							<option value="desc_partes">Nombre</option>
                    ...
                    <tr>
                      <td><table width="624" border="0"  cellpadding="0" >
                        <tr>
                          <td width="207"  class="ctablasup" >CATEGORIA</td>						 
						  <td width="234"  class="ctablasup">NOMBRE</td>
                          <td  class="ctablasup"  width="175"> OPCIONES</td>
                        </tr>
						<? 
						
						echo "<tr style='display:none'><td ><form name='forma_0' action='man_partes.php'>";
						echo "  </form> </td></tr>  ";						  
						$estilo="ctablablanc";
						$estilo="ctablagris";
						...
						while($db->next_row()) {
							...
							echo "<tr class='$estilo' $cambio_celda> <form name='forma_$db->cod_partes' action='man_partes.php'>  ";							
							echo "<td >$db->nom_clase</td>";
							echo "<td >$db->desc_partes</td>";
							echo "<td aling='center' >"; 
							echo 	"<table width='100%' border='0' cellspacing='0' cellpadding='0'>";
                            echo 	" <tr>  <td align='center'> <input type='hidden' name='codigo' value='$db->cod_partes'>";
							if ($editar==1)
							 	echo "<img src='imagenes/icoeditar.gif' alt='Editar Registro' width='16' height='16' style='cursor:pointer'  onclick='document.forma_$db->cod_partes.submit()'/></td>";
							else 
								echo "<img src='imagenes/e_icoeditar.gif' width='16' height='16'  /></td>";
                            echo 	"<td align='center'>";
							if ($eliminar==1)
								echo"<img src='imagenes/icoeliminar.gif' width='16' alt='Eliminar Registro' height='16' style='cursor:pointer' onclick=confirmar($db->cod_partes) /></td> ";
							else
...
<form name="forma" method="post" action="con_partes.php">
