	...
	<body>
		...
		<TD id="td_7" rowspan="3" align="center"><img src="../images/logo.jpg" width="160" height="74"></TD>
	 
	<TD id="td_2" align="center" class="normal"><strong>FORMATO DE COTIZACION IMPORTACION AEREA</strong></TD>
...
<TD id="td_8" align="center" class="normal"><strong>COTIZACION No CZ10030020</strong> </TD>
<TD id="td_9" align="center" class="normal"><strong>PAGINA 1 DE 2</strong></TD>
    ...
    <td bgcolor="#FFFFFF"><table style="width: 97%;" border="0" cellpadding="1" bordercolor="#000000" >
      ...
      <tr>
		...
		<td width="47%" valign="top"><table width="100%" border="1" bordercolor="#000000" cellpadding="0" cellspacing="0">
          ...
          <tr>
		  	 <td class="even_row_1" align="center">JMC LOGISTICS CARGO LTDA</td>
          </tr>
          <tr>
  ...
  <td><table style="width: 100%;" bordercolor="#000000" cellpadding="-1" cellspacing="0" border="0"  >
    <tr>
		  ...
		  <td class="subfongris" align="center" >IMPORTACION AEREA</td>
    </tr>
    ...
    <tr>
      ...
      </table></td></tr></table></td></tr><tr><td>&nbsp;</td></tr><tr><td>
	  
	   <table style="width: 100%;" cellpadding="-1" cellspacing="0" border="1" class="change_order_items">
  <tr>
    <td width="6%" class="subfongris">PAIS</td>
    <td width="11%" class="subfongris">ORIGEN</td>

  	    <td width="11%"  class="subfongris" >TARIAFA ESCALONADA SOBRE JEN / KG</td>
		
	 <td style="width:21%" class="subfongris">TIEMPO DE TRANSITO </td>
    <td style="width:21%" class="subfongris">FRECUENCIA</td>
    <td style="width:21%" class="subfongris">TARIFA A VIGENTE </td>
  	</tr>
  	<tr>
		<td height="58"  class="even_row_1">JAPON</td>

		<td  class="even_row_1">TOKIO</td>
	<!--ESCALA PARA DATOS-->
		 <td width="11%"  ><table style="width: 100%;" cellpadding="-1" cellspacing="0" border="1" class="change_order_items">
      <tr>
	  			<td class="subfongris">+1.000</td>
					<td class="subfongris">+500</td>
					<td class="subfongris">MINIMA</td>

					<td class="subfongris">+100</td>
				</tr>
		<tr>
		 		 <td class="even_row_2">300.00</td>
				 <td class="even_row_2">200.00</td>
				 <td class="even_row_2">500.00</td>
				 <td class="even_row_2">78.00</td>

				
		 </tr>
		 </table>
		 </td>
				 <td style="width:21%" class="even_row_1" >
		 		 </td>
		 <td style="width:21%; height:20%" class="even_row_1">LUNES A VIERNES</td>
		  
		   <td style="width:21%" class="even_row_1">15 MARZO 2010</td>
		 </tr>
	...
	<td width="16%" class="subfongris" style="border-right-style: none">TARIFAS</td>
	...
	<tr>
	<th class="subfongris">JPY</th>
	<th width="12%" class="subfongris">USD</th>
	<th width="12%" class="subfongris">PESOS</th>
	<th width="6%" class="subfongris">USD</th>
	<th width="8%" class="subfongris">PESOS</th>
		...
		<td class="change_order_total_col" style="border-left-style: none;">7.382.76</td>
<td class="change_order_total_col" style="border-right-style: none;">14.765.500      </td></tr>
		...
		<td class="change_order_total_col" style="border-left-style: none;">0</td>
		<td class="change_order_total_col" style="border-left-style: none;">930.60</td>
<td class="change_order_total_col" style="border-right-style: none;">1.861.200      </td></tr>
		...
		<td class="change_order_total_col" style="border-left-style: none;">0</td>
		<td class="change_order_total_col" style="border-left-style: none;">0</td>
		<td class="change_order_total_col" style="border-left-style: none;">372.24</td>
<td class="change_order_total_col" style="border-right-style: none;">744.480      </td></tr>
		...
		<td class="change_order_total_col" style="border-left-style: none;">0</td>
		<td class="change_order_total_col" style="border-left-style: none;">0</td>
		<td class="change_order_total_col" style="border-left-style: none;">750.00</td>
<td class="change_order_total_col" style="border-right-style: none;">1.500.000      </td></tr>
		...
		<td class="change_order_total_col" style="border-left-style: none;">0</td>
		<td class="change_order_total_col" style="border-left-style: none;">0</td>
		<td class="change_order_total_col" style="border-left-style: none;">45.000.00</td>
<td class="change_order_total_col" style="border-right-style: none;">90.000.000      </td></tr>
		...
		<td class="change_order_total_col" style="border-left-style: none;">0</td>
		<td class="change_order_total_col" style="border-left-style: none;">0</td>
		<td class="change_order_total_col" style="border-left-style: none;">10.500.00</td>
<td class="change_order_total_col" style="border-right-style: none;">21.000.000      </td></tr>
		...
		<td class="change_order_total_col" style="border-left-style: none;">0</td>
		<td class="change_order_total_col" style="border-left-style: none;">0</td>
		<td class="change_order_total_col" style="border-left-style: none;">4.500.00</td>
<td class="change_order_total_col" style="border-right-style: none;">9.000.000      </td></tr>
		...
		<td class="change_order_total_col" style="border-left-style: none;">0</td>
		<td class="change_order_total_col" style="border-left-style: none;">0</td>
		<td class="change_order_total_col" style="border-left-style: none;">6.500.00</td>
<td class="change_order_total_col" style="border-right-style: none;">13.000.000      </td></tr>
		...
		<td class="change_order_total_col" style="border-left-style: none;">0</td>
		<td class="change_order_total_col" style="border-left-style: none;">0</td>
		<td class="change_order_total_col" style="border-left-style: none;">12.000.00</td>
<td class="change_order_total_col" style="border-right-style: none;">24.000.000      </td></tr>
		...
		<td class="change_order_total_col" style="border-left-style: none;">0</td>
		<td class="change_order_total_col" style="border-left-style: none;">0</td>
		<td class="change_order_total_col" style="border-left-style: none;">4.20</td>
<td class="change_order_total_col" style="border-right-style: none;">8.400      </td></tr>
		...
		<td class="change_order_total_col" style="border-left-style: none;">0</td>
		<td class="change_order_total_col" style="border-left-style: none;">0</td>
		<td class="change_order_total_col" style="border-left-style: none;">12.50</td>
<td class="change_order_total_col" style="border-right-style: none;">25.000      </td></tr>
	
		   </tbody>
	   <tr>

	   <td colspan="3" style="text-align: left;">Tasa de cambio aproximada USD - $ 2.000.00</td>
  <td colspan="2" style="text-align: right;"><strong>VALOR APROXIMADO :</strong></td>
  		 <td class="change_order_total_col"><strong>87.952.30</strong></td>
 		<td class="change_order_total_col"><strong>175.904.600</strong></td>
				 </tr>
		  <tr>
			<td colspan="3" style="text-align: left;">Ruta de embarque TOKIO-MIAMI-BOGOTA</td>

<td colspan="2" style="text-align: right;">&nbsp;</td>
		 <td class="change_order_total_col">&nbsp;</td>
		<td class="change_order_total_col">&nbsp;</td>
				 </tr></table>
		 <table class="even_row_2"  align="left">
 		<tr>
	   ...
	   <tr>
  		<td colspan="3" style="white-space: normal;text-align:justify"><br />SADEREWREWR
<br />DDFDFDFDF
<br />FSDFRRRETRETRT		<p >
				NOTA ESPECIAL:</span></p>
    ...
    <p class="datos_clausuara">Cordialmente,</p>

		  <p class="datos_clausuara" >
		 <table>
		 <tr>
    <td><p style="padding-left: 4em">Nidia Carrillo<br/>
    Gerente General<br/>
    Nidia Carrillo<br/></td>
