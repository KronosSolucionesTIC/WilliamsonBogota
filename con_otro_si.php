...
var url="formatos/formato_otro_si_alquiler.php?codigo="+dato;
...
<tr>
<td valign="top" >
<form id="forma_total" name="forma_total" method="post" action="man_otro_si.php">
                  <table width="624" border="0" cellspacing="0" cellpadding="0" align="center" >
                      ...
                      <td bgcolor="#E9E9E9"><table width="624" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="160" class="ctablaform"><select name="campos" class="textfieldlista" id="campos" >
                            ...
                            <option value="cod_otro_si">Codigo</option>
							<option value="consecutivo">Contrato</option>
                            <option value="fecha_otro_si">Fecha</option>
                    ...
                    <tr>
                      <td><table width="624" border="0"  cellpadding="0">
                        <tr>
						  <td width="121"  class="ctablasup">CODIGO</td>
						  <td width="193"  class="ctablasup">CONTRATO</td>
						  <td width="167"  class="ctablasup">FECHA</td>
					      <td  class="ctablasup"  width="133">OPCIONES</td>
                        </tr>
						<? 
						
						echo "<tr style='display:none'><td ><form name='forma_0' action='man_otro_si.php'>";
						echo "  </form> </td></tr>  ";						  
						$estilo="ctablablanc";
						$estilo="ctablagris";
						...
						while($db->next_row()) {
							...
							echo "<tr class='$estilo' $cambio_celda> <form name='forma_$db->cod_otro_si' action='man_otro_si.php'>  ";
							echo "<td><div align='center'>$db->cod_otro_si</div></td>";
							echo "<td><div align='center'>$db->consecutivo</div></td>";
							echo "<td><div align='center'>$db->fecha_otro_si</div></td>";
													
                            echo "<td aling='center' >"; 
							
							echo 	"<table width='100%' border='0' cellspacing='0' cellpadding='0'>";
                            echo 	" <tr>  <td align='center'> <input type='hidden' name='codigo' value='$db->cod_otro_si'>";
							if ($editar==10)
							...
							if ($eliminar==10)
								...
								echo"<img src='imagenes/e_icoeliminar.gif' width='16' height='16'  /></td> ";
									...
									echo "<td align='center'><img src='imagenes/mirar.png' width='16' height='16'  style=\"cursor:pointer\"  onclick=\"abrir($db->cod_otro_si)\" /></td>";
                            echo "  </tr> </table>  </td>  ";
...
<form name="forma" method="post" action="con_otro_si.php">
