...
{  
if(document.getElementById("tipo_responsable").value==0){
...
<form id="forma" name="forma" method="post" action="man_responsable.php" enctype="multipart/form-data">
                    ...
                    <tr>
                      <td width="710" bgcolor="#E9E9E9"><table width="710" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          ...
                          <td colspan="3" class="titulosupsub">SELECCIONE TIPO responsable </td>
                        </tr>
                        <tr>
                          <td></td>
                          <td height="33"></td>
                          <td class="ctablaform">Tipo responsable : </td>
                          <td><select name="tipo_responsable" id="tipo_responsable" class="SELECT">
