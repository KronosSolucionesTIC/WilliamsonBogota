...
if(!empty($busquedas)) { #codigo para buscar 
	...
	$where AND tipo_factura = 2 order by cod_fac  desc";
...
if(tipo_doc=="1"){
	...
	var url="formatos/remision.php?codigo="+dato;
...
<form id="forma_total" name="forma_total" method="post" action="con_factura2.php">
                    ...
                    <tr>
                      <td width="790" bgcolor="#E9E9E9"><table width="624" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="17"> 
						  <? if ($insertar==1) {?>
					  	  <img src="imagenes/page.png" width="16" height="16"  alt="Nuevo Registro" style="cursor:pointer" onClick="location.href='con_pagos_adelanto2.php?codigo=0&editar=<?=$editar?>&insertar=<?=$insertar?>&eliminar=<?=$eliminar?>'"/>
					  	  <? } ?></td>
