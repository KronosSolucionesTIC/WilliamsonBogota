...
if($eliminacion==1) {//confirmacion de eliminacion
	$error=eliminar("contrato_alquiler",$eli_codigo,"cod_calc");
	if ($error >=1)
...
INNER JOIN paciente ON (paciente.cod_pac= contrato_alquiler.cod_paciente) $where order by consecutivo";
...
function abrir2(dato){

var url="formatos/anexo_contrato_cae.php?codigo="+dato;
window.open(url,"ventana","menubar=0,resizable=1,width=800,height=600,toolbar=0,scrollbars=yes")
...
<tr>
<td valign="top" >
<form id="forma_total" name="forma_total" method="post" action="man_alquiler.php">
                  <table width="624" border="0" cellspacing="0" cellpadding="0" align="center" >
                    <tr>
                      <td bgcolor="#E9E9E9"><table width="624" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="17"> 
						  <? if ($insertar==1) {?>
					  	  <img src="imagenes/page.png" width="16" height="16"  alt="Nuevo Registro" style="cursor:pointer" onClick="location.href='con_alquiler.php?codigo=0&editar=<?=$editar?>&insertar=<?=$insertar?>&eliminar=<?=$eliminar?>'"/>
					  	  <? } ?></td>
                          ...
                          <td width="160" class="ctablaform"><select name="campos" class="textfieldlista" id="campos" >
                            ...
                            <option value="consecutivo">Numero</option>
							<option value="nom1_cli">Nombre cliente</option>
                            <option value="apel1_cli">Apellido cliente</option>
                            <option value="nom1_pac">Nombre paciente</option>
                            <option value="apel1_pac">Apellido paciente</option>
							<option value="fecha_ini_contrato">Fecha</option>
                    ...
                    <tr>
                      <td><table width="624" border="0"  cellpadding="0">
                        <tr>
						  <td width="90"  class="ctablasup">#CONTRATO </td>
						  <td width="157"  class="ctablasup">CLIENTE</td>
						  <td width="145"  class="ctablasup">PACIENTE</td>
						  <td width="108"  class="ctablasup">FECHA INICIO </td>
					      <td  class="ctablasup"  width="112">OPCIONES</td>
                        </tr>
						<? 
						
						echo "<tr style='display:none'><td ><form name='forma_0' action='man_alquiler.php'>";
						echo "  </form> </td></tr>  ";						  
						$estilo="ctablablanc";
						$estilo="ctablagris";
						...
						while($db->next_row()) {
							...
							echo "<tr class='$estilo' $cambio_celda> <form name='forma_$db->cod_calc' action='man_alquiler.php'>  ";
							echo "<td >$db->consecutivo</td>";
							echo "<td >$db->nom1_cli $db->apel1_cli</td>";
							echo "<td >$db->nom1_pac $db->apel1_pac</td>";
							echo "<td >$db->fecha_ini_contrato</td>";						
							
													
                            echo "<td aling='center' >"; 
							
							echo 	"<table width='100%' border='0' cellspacing='0' cellpadding='0'>";
                            echo 	" <tr>  <td align='center'> <input type='hidden' name='codigo' value='$db->cod_calc'>";
							if ($editar==1)
							 	echo "<img src='imagenes/icoeditar.gif' alt='Editar Registro' width='16' height='16' style='cursor:pointer'  onclick='document.forma_$db->cod_calc.submit()'/></td>";
							else 
								echo "<img src='imagenes/e_icoeditar.gif' width='16' height='16'  /></td>";
                            echo 	"<td align='center'>";
								
									echo "<td align='center'><img src='imagenes/mirar.png' width='16' height='16'  style=\"cursor:pointer\"  onclick=\"abrir($db->cod_calc,'$tipo')\" /></td>";
									
									echo "<td align='center'><img src='imagenes/mirar.png' width='16' height='16'  style=\"cursor:pointer\"  onclick=\"abrir2($db->cod_calc,'$tipo')\" /></td>";
...
<form name="forma" method="post" action="con_contrato_alquiler.php">
