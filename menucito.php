...
<style type="text/css">
/* Inset 3D Curved */
.inset {background: transparent; width:98%; height:95%;  }
...
.inset .b2, .inset .b2b {margin:0 1px; border-width:0 1px;}
...
<table   height="210" border="0" >
  ...
  <td align="center">&nbsp;</td>
      ...
      <tr valign="top">
        <td  align="left"><? include("menus/data.php") ?>
		
	    </td>
      </tr>
	   <tr>
        <td><a href="index.html" ></a><span class="Estilo1"> <a href="#" onClick="cerrar()"  > &nbsp;&nbsp;&nbsp;<span class="style2 Estilo1">SALIR </span></a></span></td>
      </tr>
</table>
