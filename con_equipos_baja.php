...
if($eliminacion==1) {//confirmacion de eliminacion 
	$error=eliminar("bajas",$eli_codigo,"cod_baja");
	if ($error >=1)
...
var url="formatos/formato_baja_alquiler.php?codigo="+dato;
...
<form id="forma_total" name="forma_total" method="post" action="man_equipos_baja.php">
                  <table width="600" border="0" cellspacing="0" cellpadding="0" align="center" >
                    <tr>
                      <td bgcolor="#E9E9E9"><table width="600" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="17"> 
						  <? if ($insertar==1) {?>
					  	  <img src="imagenes/page.png" width="16" height="16"  alt="Nuevo Registro" style="cursor:pointer" onClick="location.href='con_equipos_baja2.php?codigo=0&editar=<?=$editar?>&insertar=<?=$insertar?>&eliminar=<?=$eliminar?>'"/>
					  	  <? } ?></td>
                          ...
                          <td width="160" class="ctablaform"><select name="campos" class="textfieldlista" id="campos" >
						   ...
						   <option value="consecutivo_equipo">Consecutivo</option>
                            <option value="fecha_baja">Fecha baja</option>
							<option value="desc_tipo_baja">Tipo baja</option>
                    ...
                    <tr>
                      <td><table width="819" border="0"  cellpadding="0">
                        <tr>
                          <td width="138"  class="ctablasup">CONSECUTIVO</td>
                          <td width="224"  class="ctablasup">EQUIPO</td>
						  <td width="166"  class="ctablasup">FECHA BAJA</td>
						  <td  class="ctablasup"  width="118">TIPO BAJA</td>					
                          <td  class="ctablasup"  width="159">OPCIONES</td>
                        </tr>
						<? 
						
						echo "<tr style='display:none'><td ><form name='forma_0' action='man_equipos_baja.php'>";
						echo "  </form> </td></tr>  ";						  
						$estilo="ctablablanc";
						$estilo="ctablagris";
						...
						while($db->next_row()) {
							...
							echo "<tr class='$estilo' $cambio_celda> <form name='forma_$db->cod_baja' action='man_equipos_baja.php'>  ";
							...
							echo "<td><div align='center'>$db->fecha_baja</div></td>";
							echo "<td><div align='center'>$db->desc_tipo_baja</div></td>";
							echo "<td aling='center' >"; 
							echo 	"<table width='100%' border='0' cellspacing='0' cellpadding='0'>";
                            echo 	" <tr>  <td align='center'> <input type='hidden' name='codigo' value='$db->cod_baja'>";
...
<form name="forma" method="post" action="con_equipos_baja.php">
