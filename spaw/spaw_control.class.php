...
include '../class/toolbars.class.php';
...
class SPAW_Wysiwyg {
  ...
  function getHtml()
  {
    ...
    if ($this->checkBrowser())
    {
      ...
      {
        $buf.="setTimeout('document.all.".$n.".value ".$plus."=\"".str_replace('-->','@@END_COMMENT',str_replace('<!--','@@START_COMMENT',str_replace('"','&quot;',str_replace("'","\'",str_replace("\\","\\\\\\\\",$line)))))."\\\\n\";',0);\n";
        $plus = "+";
      }

      $buf.="setTimeout('document.all.".$n.".value = document.all.".$n.".value.replace(/&quot;/g,\'\"\');',0);"."\n";
      $buf.="setTimeout('document.all.".$n.".value = document.all.".$n.".value.replace(/@@START_COMMENT/g,\'<!--\');',0);"."\n";
      $buf.="setTimeout('document.all.".$n.".value = document.all.".$n.".value.replace(/@@END_COMMENT/g,\'-->\');',0);"."\n";
