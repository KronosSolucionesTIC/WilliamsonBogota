...
switch ($op){
	...
	include ("spaw/spaw_control.class.php");
 	$sw3 = new SPAW_Wysiwyg('add_content' /*name*/,stripslashes($HTTP_POST_VARS['add_content']) /*value*/,
	...
	//echo "<textarea name=\"content\" rows=\"18\" wrap=\"virtual\" cols=\"80\">$content</textarea><br><br>";
    if ($multilingual == 1) {
	echo "<b>"._LANGUAGE.": </b>"
