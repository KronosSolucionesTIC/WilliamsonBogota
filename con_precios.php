...
<tr>
<td valign="top" >
<form id="forma_total" name="forma_total" method="post" action="man_precios.php">
                  <table width="624" border="0" cellspacing="0" cellpadding="0" align="center" >
                    <tr>
                      <td bgcolor="#E9E9E9"><table width="624" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="17"> 
						  <? if ($insertar==1) {?>
					  	  <img src="imagenes/page.png" width="16" height="16"  alt="Nuevo Registro" style="cursor:pointer" onClick="location.href='man_precios.php?codigo=0&editar=<?=$editar?>&insertar=<?=$insertar?>&eliminar=<?=$eliminar?>'"/>
					  	  <? } ?></td>
                    ...
                    <tr>
                      <td><table width="825" border="0"  cellpadding="0">
                        <tr>
                          <td width="121"  class="ctablasup">CONSECUTIVO</td>
                          <td width="284"  class="ctablasup">NOMBRE</td>
                          <td width="154"  class="ctablasup">CANON DE ARRENDAMIENTO </td>
						  <td width="105"  class="ctablasup">DEPOSITO</td>					
                        </tr>
						<? 
						
						echo "<tr style='display:none'><td ><form name='forma_0' action='man_precios.php'>";
						echo "  </form> </td></tr>  ";						  
						$estilo="ctablablanc";
						$estilo="ctablagris";
						...
						while($db->next_row()) {
							...
							echo "<tr class='$estilo' $cambio_celda> <form name='forma_$db->cod_equipo' action='man_precios.php'>  ";
							echo "<td >$db->consecutivo_equipo</td>";
							echo "<td >$db->nom_clase-$db->desc_tipo_equipos</td>";
							echo "<td >$db->canon_arrend_equipo</td>";
							echo "<td >$db->valor_deposito</td>";
							echo "  </form></tr>  ";
...
<form name="forma" method="post" action="con_precios.php">
