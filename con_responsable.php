...
if($eliminacion==1) {//confirmacion de eliminacio 
	$error=eliminar("responsable",$eli_codigo,"cod_cli");
	if ($error >=1)
...
$sql="SELECT * FROM responsable $where order by nom1_cli";
...
<tr>
<td valign="top" >
<form id="forma_total" name="forma_total" method="post" action="man_responsable.php">
                  <table width="624" border="0" cellspacing="0" cellpadding="0" align="center" >
                    <tr>
                      <td bgcolor="#E9E9E9"><table width="624" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="17"> 
						  <? if ($insertar==1) {?>
					  	  <img src="imagenes/page.png" width="16" height="16"  alt="Nuevo Registro" style="cursor:pointer" onClick="location.href='con_responsable2.php?codigo=0&editar=<?=$editar?>&insertar=<?=$insertar?>&eliminar=<?=$eliminar?>'"/>
					  	  <? } ?></td>
                          ...
                          <td width="160" class="ctablaform"><select name="campos" class="textfieldlista" id="campos" >
                            ...
                            <option value="apel1_cli">Apellido</option>
							<option value="cedula_cli">Cedula</option>
                            <option value="dir_cli">Direccion</option>
							<option value="tel_cli">Telefono</option>
							<option value="fax_cli">Celular</option>
                    ...
                    <tr>
                      <td><table width="624" border="0"  cellpadding="0">
						...
						echo "<tr style='display:none'><td ><form name='forma_0' action='man_responsable.php'>";
						echo "  </form> </td></tr>  ";						  
						$estilo="ctablablanc";
						$estilo="ctablagris";
						...
						while($db->next_row()) {
							...
							echo "<tr class='$estilo' $cambio_celda> <form name='forma_$db->cod_cli' action='man_responsable.php'>  ";
							$nombre_cli =letra_capital($db->nom1_cli);
							$apellido_cli =letra_capital($db->apel1_cli);
							$nit=$db->cedula_cli;
							//$nit=convertir_nit($db->cedula_cli);
							$direccion =letra_capital($db->direccion_cli);
							$telefono =letra_capital($db->telefono_cli);
							echo "<td >$nombre_cli $apellido_cli</td>";
							echo "<td >$nit</td>";
...
<form name="forma" method="post" action="con_responsable.php">
