...
if($eliminacion==1) {//confirmacion de eliminacion 
	$error=eliminar("sucursal",$eli_codigo,"cod_suc");
	if ($error >=1)
...
$sql="SELECT  * FROM sucursal $where order by nom_suc";
...
<tr>
<td valign="top" >
<form id="forma_total" name="forma_total" method="post" action="man_sucursal.php">
                    ...
                    <tr>
                      <td bgcolor="#E9E9E9"><table width="624" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="17"> 
						  <? if ($insertar==1) {?>
					  	  <img src="imagenes/page.png" width="16" height="16"  alt="Nuevo Registro" style="cursor:pointer" onClick="location.href='man_sucursal.php?codigo=0&editar=<?=$editar?>&insertar=<?=$insertar?>&eliminar=<?=$eliminar?>'"/>
					  	  <? } ?></td>
                          ...
                          <td width="160" class="ctablaform"><select name="campos" class="textfieldlista" id="campos" >
                            ...
                            <option value="nom_suc">Nombre</option>
                            <option value="direccion_suc">Direccion</option>
							<option value="email_suc">E-Mail</option>
							<option value="cont_suc">Telefono</option>
							<option value="fax_suc">Fax</option>
                      ...
                      <td><table width="624" border="0"  cellpadding="0">
                        <tr>
						  ...
						  <td  class="ctablasup">TELEFONO</td>
						   <td  class="ctablasup">FAX</td>
						  <td  class="ctablasup"  width="112">OPCIONES</td>
                        </tr>
						<? 
						
						echo "<tr style='display:none'><td ><form name='forma_0' action='man_sucursal.php'>";
						echo "  </form> </td></tr>  ";						  
						$estilo="ctablablanc";
						$estilo="ctablagris";
						...
						while($db->next_row()) {
							...
							echo "<tr class='$estilo' $cambio_celda> <form name='forma_$db->cod_suc' action='man_sucursal.php'>  ";
							$nombre = letra_capital($db->nom_suc);					  
							$direccion =letra_capital($db->direccion_suc);
							$telefono = letra_capital($db->cont_suc);
							$fax = letra_capital($db->fax_suc);
						
							echo "<td >$nombre</td>";
							echo "<td >$direccion </td>";
							echo "<td >$db->email_suc </td>";
							echo "<td >$db->tel_suc</td>";
							echo "<td >$fax </td>";
                            echo "<td aling='center' >"; 
							
							echo 	"<table width='100%' border='0' cellspacing='0' cellpadding='0'>";
                            echo 	" <tr>  <td align='center'> <input type='hidden' name='codigo' value='$db->cod_suc'>";
							if ($editar==1)
							 	echo "<img src='imagenes/icoeditar.gif' alt='Editar Registro' width='16' height='16' style='cursor:pointer'  onclick='document.forma_$db->cod_suc.submit()'/></td>";
							else 
								echo "<img src='imagenes/e_icoeditar.gif' width='16' height='16'  /></td>";
                            echo 	"<td align='center'>";
							if ($eliminar==1)
								echo"<img src='imagenes/icoeliminar.gif' width='16' alt='Eliminar Registro' height='16' style='cursor:pointer' onclick=confirmar($db->cod_suc) /></td> ";
							else
...
<form name="forma" method="post" action="con_sucursal.php">
