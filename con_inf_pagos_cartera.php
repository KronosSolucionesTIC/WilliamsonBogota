...
function abrir() {		
	...
	imprimir_inf("inf_pagos_cartera.php",'0&cod_estado='+cod_estado,'mediano');
}
  ...
  <tr>
    <td valign="top" ><form id="forma_total" name="forma_total" method="post" action="formatos/ver_traza.php">
      <table width="624" border="0" cellspacing="0" cellpadding="0" align="center" >
        <tr>
          <td bgcolor="#999999"><div align="center" class="Estilo1">INFORME  PAGOS </div></td>
        </tr>
        <tr>
          <td><table width="524" border="0"  cellpadding="0" align="center">
            ...
            <tr>
              <td width="81" class="textotabla01" >Estado:</td>
              <td width="271" ><? combo_evento("estado","estado_pago","cod_estado_pago","desc_estado_pago","","","desc_estado_pago"); ?></td>
