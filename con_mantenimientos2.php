...
<form id="forma" name="forma" method="post" action="man_mantenimientos.php" enctype="multipart/form-data">
                    ...
                    <tr>
                      <td width="510" bgcolor="#E9E9E9"><table width="510" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          ...
                          <? combo_evento3("equipos","equipos","cod_equipo","concat(`consecutivo_equipo`,' ',`nom_clase`,' ',`nom_equipo`,' ',`desc_tipo_equipos`)","","","estado_arrend_equipo = 2", 
